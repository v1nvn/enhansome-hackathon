...
> This list tries to cover what is ⚡️awesome⚡️ about [hackathons](https://en.wikipedia.org/wiki/Hackathon), hackdays and hacknights, and the community of organizers who run them! See also 🕶️[awesome-hackathons](https://github.com/mbiesiad/awesome-hackathons) ⭐ 48 | 🐛 1 | 📅 2024-05-24, 🕶️[awesome-hackathon-projects](https://github.com/Olanetsoft/awesome-hackathon-projects) ⭐ 1,602 | 🐛 3 | 📅 2025-05-20 and 🕶️[awesome-hackathon-starters](https://github.com/geekcamp-ph/awesome-hackathon-starters/issues/12) ⭐ 37 | 🐛 1 | 📅 2016-07-17. Are you interested in the *science* of hackathons? Join our new 📚 [Zotero library](https://www.zotero.org/groups/5538025/awesome_hackathons).
...
* [Civic Tech Exchange](https://github.com/DemocracyLab/CivicTechExchange) ⭐ 104 | 🐛 147 | 🌐 JavaScript | 📅 2026-03-05 - Online platform for Democracy Lab projects.
* [Dribdat](https://github.com/dribdat/dribdat) ⭐ 82 | 🐛 91 | 🌐 Python | 📅 2026-03-07 - **Hackathons for impact, based on open data and web standards.** `python` `js`
...
* [HackPortal](https://github.com/acmutd/hackportal) ⭐ 48 | 🐛 28 | 🌐 TypeScript | 📅 2025-01-27 - A platform from HackUTD for user-friendly event management.
...
* [Hackme](https://github.com/p1utoze/Hackme) ⭐ 1 | 🐛 6 | 🌐 Python | 📅 2026-03-02 (unmaintained?) - Minimalistic hackathon registration and participant status monitoring.
...
* [Hack Club](https://github.com/hackclub/hackathons#readme) ⭐ 160 | 🐛 11 | 🌐 JavaScript | 📅 2026-02-28 - A curated list of hackathons organized for high schoolers.
...
* [Awesome README](https://github.com/matiassingers/awesome-readme) ⭐ 20,543 | 🐛 1 | 📅 2026-03-04 - A list to inspire your coaches to motivate your teams to document their efforts ...with panache.
...
* [Gavel](https://github.com/anishathalye/gavel) ⭐ 475 | 🐛 11 | 🌐 Python | 📅 2026-02-20 - A project expo judging system by HackMIT that uses fancy math to get good results.
...
This repo is made with [generator-awesome-list](https://github.com/dar5hak/generator-awesome-list) ⭐ 373 | 🐛 7 | 🌐 JavaScript | 📅 2026-03-05 by Darshak Parikh and :heart: motivated by [awesome-hackathons](https://github.com/cconsidine/awesome-hackathons) by Camille Considine.
