...
> This list tries to cover what is ⚡️awesome⚡️ about [hackathons](https://en.wikipedia.org/wiki/Hackathon), hackdays and hacknights, and the community of organizers who run them! See also 🕶️[awesome-hackathons](https://github.com/mbiesiad/awesome-hackathons) ⭐ 48 | 🐛 1 | 📅 2024-05-24, 🕶️[awesome-hackathon-projects](https://github.com/Olanetsoft/awesome-hackathon-projects) ⭐ 1,605 | 🐛 3 | 📅 2025-05-20 and 🕶️[awesome-hackathon-starters](https://github.com/geekcamp-ph/awesome-hackathon-starters/issues/12) ⭐ 37 | 🐛 1 | 📅 2016-07-17. Are you interested in the *science* of hackathons? Join our new 📚 [Zotero library](https://www.zotero.org/groups/5538025/awesome_hackathons).
...
* [Dribdat](https://github.com/dribdat/dribdat) ⭐ 82 | 🐛 93 | 🌐 Python | 📅 2026-03-14 - **Hackathons for impact, based on open data and web standards.** `python` `js`
...
* [Scrapbook](https://github.com/hackclub/scrapbook) ⭐ 194 | 🐛 19 | 🌐 JavaScript | 📅 2026-03-13 by HackClub - A daily streak system & portfolio for your projects.
...
* [Awesome README](https://github.com/matiassingers/awesome-readme) ⭐ 20,583 | 🐛 1 | 📅 2026-03-10 - A list to inspire your coaches to motivate your teams to document their efforts ...with panache.
...
This repo is made with [generator-awesome-list](https://github.com/dar5hak/generator-awesome-list) ⭐ 373 | 🐛 2 | 🌐 JavaScript | 📅 2026-03-13 by Darshak Parikh and :heart: motivated by [awesome-hackathons](https://github.com/cconsidine/awesome-hackathons) by Camille Considine.
