...
By *awesome 🕶️ hackathon platforms*, we mean web or mobile applications that are specifically designed to run a hackathon, or which have effectively adapted for use in events of this type. They typically allow organizers to announce the schedule and topics, register participants, and document the results.
...
* [Dribdat](https://github.com/dribdat/dribdat) ⭐ 82 | 🐛 92 | 🌐 Python | 📅 2026-02-11 - **Hackathons for impact, based on open data and web standards.** `python` `js`
...
* [OpenHackathon](https://github.com/kaiyuanshe/OpenHackathon-Web) ⭐ 15 | 🐛 0 | 🌐 TypeScript | 📅 2025-06-30 - Platform with Git-based Cloud Development Environment based on Next.js.
* [Halo](https://github.com/tcnj-acm/halo) ⭐ 10 | 🐛 3 | 🌐 HTML | 📅 2025-03-10 - Hackathon Management System built on Django.
* [Hack the Back](https://github.com/hackthevalley/hack-the-back) ⭐ 5 | 🐛 0 | 🌐 HTML | 📅 2025-12-05 - An elegant backend, with ready-made GraphQL and REST endpoints.
...
* [HackPortal](https://github.com/acmutd/hackportal) ⭐ 48 | 🐛 27 | 🌐 TypeScript | 📅 2025-01-27 - A platform from HackUTD for user-friendly event management.
* [HackathonManager](https://github.com/codeRIT/hackathon-manager) ⭐ 31 | 🐛 71 | 🌐 Ruby | 📅 2024-10-04 - Hackathon registration & logistics, compatible with MyMLH.
...
* [hms](https://github.com/knoffhoff/hms) ⭐ 11 | 🐛 72 | 🌐 TypeScript | 📅 2026-02-01 - Hackathon Management System for Azure by knoffhoff.
...
* [Kent Hack Enough](https://github.com/hacksu/kenthackenough) ⭐ 6 | 🐛 20 | 🌐 JavaScript | 📅 2023-03-01 - Legacy registration and staff management API for HackSU events.
* [Ninjathon](https://github.com/shilomagen/hackathon-matching-platform) ⭐ 5 | 🐛 0 | 🌐 JavaScript | 📅 2019-01-15 - Hackathon managing platform.
* [VersusVirus App](https://github.com/VersusVirus-Hackathons/VersusVirus-App) ⭐ 4 | 🐛 8 | 🌐 TypeScript | 📅 2020-06-24 - For managing teams at large online hackathons.
* [Scout24](https://github.com/Scout24/hackathon-management-system) ⚠️ Archived - Hackathon management system from a company.
* [Hacksuite](https://github.com/DevtranetHQ/Hacksuite) ⭐ 2 | 🐛 14 | 🌐 JavaScript | 📅 2023-04-07 - A fullstack suite of apps from [Devtranet](https://devtranet.tech/) for hosting virtual hackathons.
...
* [Hackme](https://github.com/p1utoze/Hackme) ⭐ 1 | 🐛 6 | 🌐 Python | 📅 2026-02-16 (unmaintained?) - Minimalistic hackathon registration and participant status monitoring.
...
* [Scrapbook](https://github.com/hackclub/scrapbook) ⭐ 192 | 🐛 39 | 🌐 JavaScript | 📅 2026-02-19 by HackClub - A daily streak system & portfolio for your projects.
* [Hack Club](https://github.com/hackclub/hackathons#readme) ⭐ 160 | 🐛 10 | 🌐 JavaScript | 📅 2026-02-16 - A curated list of hackathons organized for high schoolers.
...
* [Awesome README](https://github.com/matiassingers/awesome-readme) ⭐ 20,446 | 🐛 1 | 📅 2026-02-19 - A list to inspire your coaches to motivate your teams to document their efforts ...with panache.
...
* [Gavel](https://github.com/anishathalye/gavel) ⭐ 474 | 🐛 10 | 🌐 Python | 📅 2026-01-08 - A project expo judging system by HackMIT that uses fancy math to get good results.
...
* [MLH Organizer Guide](https://github.com/MLH/mlh-hackathon-organizer-guide) ⭐ 341 | 🐛 17 | 🌐 CSS | 📅 2026-02-14 - Guide from Major League Hacking, popular at US schools.
...
Contributions welcome! Please read the [guidelines](origin/contributing.md) first. Make sure to provide a name, link, description, in alphabetical order, in the appropriate section. Don't worry about making a mistake: your [Pull Request](https://www.freecodecamp.org/news/how-to-make-your-first-pull-request-on-github-3/) will be an opportunity to discuss and make amends.

## Footnotes

This repo is made with [generator-awesome-list](https://github.com/dar5hak/generator-awesome-list) ⭐ 373 | 🐛 5 | 🌐 JavaScript | 📅 2026-02-18 by Darshak Parikh and :heart: motivated by [awesome-hackathons](https://github.com/cconsidine/awesome-hackathons) by Camille Considine.
